...
public class QiNiuUtils {
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "BTTaLuT5GzAVUxJ6Y16TVrVA_-yCJ_mGLp5xJ1Nl";
    private static final String SECRET_KEY = "gwd4SinAIVQiUwMi4vVKBTfxAsO_MH2aO7fIvTFN";

    // 要上传的空间
    private static final String bucketname = "wangjia_001";
    // 密钥
    private static final Auth auth = Auth.create(ACCESS_KEY, SECRET_KEY);
    // 外链默认域名
    private static final String DOMAIN = "poxgj8cq6.bkt.clouddn.com";
    ...
    public static String put64image(byte[] base64, String key) throws Exception{
        ...
        String url = "http://upload-z1.qiniu.com/putb64/" + length + "/key/"+ UrlSafeBase64.encodeToString(key);
