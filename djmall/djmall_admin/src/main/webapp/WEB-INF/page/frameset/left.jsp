...
<script type="text/javascript" src="<%=request.getContextPath()%>/res/layer/layer.js"></script>
	<script type="text/javascript">
		...
		var zNodes =[
			...
			{ id:1112, pId:111, name:"订单展示", url:"<%=request.getContextPath()%>/user/toOrderList", target:"right"},
         ...
         /*   { id:2, pId:0, name:"商城", open:true},
			...
			{ id:222, pId:2, name:"个人中心"},
            { id:2222, pId:2, name:"用户登录-普通"},
            { id:2222, pId:2, name:"用户登录-手机"},
            { id:2222, pId:2, name:"用户注册"},*/
		];
